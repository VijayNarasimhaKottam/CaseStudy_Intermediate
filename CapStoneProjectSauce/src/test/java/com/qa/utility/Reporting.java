...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		xReports.setSystemInfo("QA Name", "Vijay");
		 ...
		 xTest = xReports.createTest(tr.getName());
		        ...
		        if (tr.getStatus() == ITestResult.FAILURE) {
		            try {
		                ...
		                String screenshotName = tr.getName() + "_screenshot.png";
		                TakesScreenshot ts = (TakesScreenshot) driver; // Assuming you have a WebDriver instance named 'driver'
		                ...
		                xTest.fail("Screenshot for the failed test is: " + xTest.addScreenCaptureFromPath(screenshotPath));
		            } catch (IOException e) {
		                e.printStackTrace();
		            }
		        }
